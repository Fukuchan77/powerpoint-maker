          ...
          slides: [
            {
              ...
              bullet_points: ['Artificial Intelligence is transforming industries worldwide'],
              bullets: [
                {
...
The AI market is expected to grow significantly in the coming years.`;
    ...
    await expect(page.getByText('Slide 2: Machine Learning vs Deep Learning')).toBeVisible();
  ...
  test('text input error handling - timeout', async ({ page }) => {
    ...
    // Enter text
    await page.getByTestId('text-input-textarea').fill('Test content for timeout');
  ...
  test('text input error handling - server error', async ({ page }) => {
    ...
    // Enter text
    await page.getByTestId('text-input-textarea').fill('Test content for error');
