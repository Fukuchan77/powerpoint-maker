    ...
    try {
      ...
      if (axios.isAxiosError(err)) {
        ...
        if (err.code === "ECONNABORTED") {
          setError(
            "Request timed out. Research is taking longer than expected. Please try again.",
          );
          ...
          setError(
            `Invalid input: ${err.response?.data?.detail || "Please check your topic"}`,
          );
          ...
          setError(
            `Server error occurred: ${err.response?.data?.detail || "Unexpected error"}`,
          );
